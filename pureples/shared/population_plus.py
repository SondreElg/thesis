...
class Population(object):
    ...
    def run(self, fitness_function, n=None):
        ...
        while n is None or k < n:
            ...
            if self.config.training_setup:
                train_set = self.config.training_setup["function"](
                    *self.config.training_setup["params"], self.config.trials
                )
                setattr(self.config, "train_set", train_set)
            ...
            if self.best_genome is None or best.fitness > self.best_genome.fitness:
                ...
                self.best_testing_set = self.config.train_set
