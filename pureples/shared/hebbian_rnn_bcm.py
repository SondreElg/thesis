...
class HebbianRecurrentNetwork(object):
    def __init__(self, inputs, outputs, node_evals, firing_threshold):
        ...
        self.hebbian_buffer = {
            ...
            for node, ignored_activation, ignored_aggregation, ignored_bias, ignored_response, links, learning_rate, firing_threshold in node_evals
        }
    ...
    def reset(self):
        ...
        self.hebbian_buffer = {
            ...
            for node, ignored_activation, ignored_aggregation, ignored_bias, ignored_response, links, learning_rate, firing_threshold in self.node_evals
        }
    ...
    def update_hebbians(self, update_factor, apply):
        ...
        for idx, (
            ...
            for i, w, h in links:
                ...
                input_val = self.ovalues[i] - firing_threshold
                output_val = self.ovalues[node] - firing_threshold
                ...
                firing_threshold = firing_threshold * 0.8 + self.ovalues[node] * 0.2
